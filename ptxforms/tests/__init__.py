...
test_spec = {
    # const.ROUTE_GET_OSINT_PASSIVE: {
    #     'types': [MALTEGO_DOMAIN, MALTEGO_IP],
    #     'params': {'query': 'passivetotal.org'}
    # },
    # const.ROUTE_GET_ATTRIBUTE_PARENT_PAIRS: {
    #     'types': [MALTEGO_DOMAIN],
    #     'params': {'query': 'passivetotal.org'}
    # },
    const.ROUTE_GET_ATTRIBUTE_CHILD_PAIRS: {
        'types': [MALTEGO_DOMAIN],
        'params': {'query': 'antivirus.safetynote.xyz'}
    },
    ...
    #     'params': {'query': 'sale@frostdomains.com'}
    # },
    ...
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'ul. Chistyakovoy, 12-190'}
    # },
    ...
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_ADDTHIS_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_ADDTHIS_USERNAME: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_FACEBOOK_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_GITHUB_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_GOOGLE_TAGMANAGER: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_GOOGLE_PLUS_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_LINKEDIN_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_OPTIMIZELY_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_STACKOVERFLOW_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_TWITTER_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_WHOSAMUNGUS_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # },
    # const.ROUTE_SEARCH_TRACKERS_YOUTUBE_ID: {
    #     'types': [MALTEGO_PHRASE],
    #     'params': {'query': 'RiskIQ'}
    # }
}
